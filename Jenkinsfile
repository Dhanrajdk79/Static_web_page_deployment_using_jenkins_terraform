pipeline {
  ...
  environment {
    DEPLOY_USER        = 'ubuntu'
<<<<<<< HEAD
    DEPLOY_HOST        = '54.226.103.122'
=======
    DEPLOY_HOST        = '54.236.250.103'
>>>>>>> c913ce324bd2c2fe5c5892f299c9cc8eeaa2c6c6
    DEPLOY_PATH        = '/var/www/html'
    SSH_CREDENTIALS_ID = 'web-key'
    REPO_URL           = 'https://github.com/aniket-jagadale/static-web-page-deployement-using-jenkins-cicd.git'
    BRANCH             = 'main'
  }
